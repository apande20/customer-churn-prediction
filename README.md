# Telco Classification Project by Abhinash Pandey
...
Customer churn is one of the most important metrics for a growing business to evaluate. It is easier to save an existing customer before they leave than to convince them to come back. Understanding and preventing customer churn is critical to a company's long-term success.

In this project, we use statistical testing to analyze the key factors of customers who are more likely to churn, develop a classification model to predict churn based on those factors, and provide recommendations for retaining customers as well as predictions of churn for a list of customers (delivered via csv).
...
*Tenure* | Integer ranging from 0-72 | This shows how long (months) does the customer stay with the company
*Online Backup* | 1) Yes 2) No 3) No internet service | This indicates if the customer has online backup service
...
- Write query to join useful tables to gather all data about the customers: customers, contract_types, payment_types, internet_service_types 
     ```sh
...
- Create decision tree classifier and fit train dataset

- Find the max depth for the best performing decision tree classifier (evaluated using classification report, accuracy score)
...
- [x] Clone this repository (including the **acquire.py**, **prepare.py** and **churn_rates.xlsx**) 
...
## About the Developer
**Abhinash Pandey** is a Financial Analyst with over 4 years of experience delivering financial analysis, modeling, and risk assessment. This project represents an application of Python and SQL to business intelligence and customer retention strategies.

- **Email:** abhinash.p3710@gmail.com
- **LinkedIn:** [linkedin.com/in/abhinashpandey1/](https://www.linkedin.com/in/abhinashpandey1/)
- **Expertise:** SQL, Python, VBA, Financial Modeling, Data-Driven Strategic Decisions

*Original project framework by Meredith Wang; currently maintained and updated by Abhinash Pandey.*